                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form @submit="onSubmit">
                                <CustomInput type="text" name="title" label="Title" placeholder="Title" />
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <button :disabled="loading" class="w-100 py-1 btn btn-lg btn-secondary"
                                        @click="emits('close')" type="reset">
                                        Cancel
                                    </button>
                                </div>
                            </form>
